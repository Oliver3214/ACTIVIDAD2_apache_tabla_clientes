...
Cliente cliente;
    ...
    public void select_datos(){
        ...
        txt_nit.setText(tbl_cliente.getValueAt(fila, 0).toString());
        txt_nombres.setText(tbl_cliente.getValueAt(fila, 0).toString());
        txt_apellidos.setText(tbl_cliente.getValueAt(fila, 0).toString());
        txt_direccion.setText(tbl_cliente.getValueAt(fila, 0).toString());
        txt_telefono.setText(tbl_cliente.getValueAt(fila, 0).toString());
        txt_fn.setText(tbl_cliente.getValueAt(fila, 0).toString());
    }
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        // TODO add your handling code here:
                // TODO add your handling code here:
        cliente = new Cliente(txt_nit.getText(),Integer.valueOf(lbl_id.getText()) ,txt_nombres.getText(),txt_apellidos.getText(),txt_direccion.getText(),txt_telefono.getText(),txt_fn.getText());
        cliente.actualizar();
        tbl_cliente.setModel(cliente.leer());
